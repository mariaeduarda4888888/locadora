...
public class ClienteDAO extends ExecuteSQL{
            ...
            return e.getMessage();
                ...
                if ( rs != null){
                    while (rs.next()) {
                        ...
                        a.getCPF(rs.getString(4));
                        a.getTelefone(rs.getString(5));
                        a.getEmail(rs.getString(6));
        ...
        List<Cliente> lista = new ArrayList<>();
         ...
         try{
                ...
                if ( rs != null){
                 ...
                 public List<Cliente> Pesquiisar_Cod_Cliente(int cod){
        ...
        String sql = "update cliente set nome = ? , data_nasc = ?, rg = ? "
                + ",cpf = ? ,email = ? ,telefone = ? ,bairoo = ? ,rua = ?"
                + ",numero = ? ,cep = ? where idcliente = ?";
        try{
            PreparedStatement ps = getCon().prepareStatement(sql);
            ps.setString(1, a.getNome());
            ps.setString(2, a.Nascimento());
            ps.setString(3, a.getRG());
            ps.setString(4, a.getCPF());
            ps.setString(5, a.getEmail());
            ps.setString(6, a.getTelefone());
           ...
           return e.getMessage();
            ...
            String sql = "Select nome cliente order by nome ";
            List<Cliente> lista = new ArrayList<>();
            try{
            PreparedStatement ps = getCon().prepareStatement(sql);
            ResultSet rs = ps.executeQuery();
